...
class Tab extends Controller
{
    ...
    {
        return view('employee.profile.tab.'.$rq->tab)->render();
    }
    ...
    public function view_employment_details($rq,$components,$employee)
    {
        ...
        return view('employee.profile.tab.'.$rq->tab, compact('employee','isRegisterEmployee','options'))->render();
    ...
    public function view_account_security($rq,$components,$employee)
    {
        ...
        $isSystemAdmin = false;
        $emp_account = $employee->emp_account;
        return view('employee.profile.tab.'.$rq->tab,compact('employee','isRegisterEmployee','emp_account','isSystemAdmin'))->render();
    }
