...
export var dtOvertimeRequisition = function (param=false) {
    ...
    const _page = $('.page-overtime-requisition');
    ...
    function initTable(){
        ...
        dataTableHelper.initTable(
            'hris/admin/approvals/overtime_requisition/dt',
            {
        ...
        $(`#${_table}_table`).ready(function() {
            ...
            $(`#${_table}_table`).on('click','.history',function(e){
                ...
                formData.append('id',id);
                _request.post('/hris/admin/approvals/overtime_requisition/view_history',formData)
                .then((res) => {
