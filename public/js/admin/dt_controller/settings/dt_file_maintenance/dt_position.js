...
export var dtPosition = function (param) {

    const _page = $('.page-file-maintenance-settings');
    const _table = 'position';
    const _tab = $(`.${_table}`);
    ...
    function initTable(){
        ...
        dataTableHelper.initTable(
            'hris/admin/settings/file_maintenance/position/dt',
            {
                filter_status:false,
            },
            [
                ...
                {
                    data: "name", name: "name", title: "Position",
                    sortable:false,
                },
                {
        ...
        $(`#${_table}_table`).ready(function() {
            ...
            $(`#${_table}_table`).on('click','.view-details',function(e){
                ...
                let modal_id = '#modal_add_position';
                let form = $('#form_add_position');

                let formData = new FormData;

                formData.append('id',id);
                _request.post('/hris/admin/settings/file_maintenance/position/info',formData)
                .then((res) => {
            ...
            $(`#${_table}_table`).on('click','.delete',function(e){
                ...
                Alert.confirm('question','Delete this record ?',{
                    onConfirm: function() {
                        formData.append('id',id);
                        _request.post('/hris/admin/settings/file_maintenance/position/delete',formData)
                        .then((res) => {
