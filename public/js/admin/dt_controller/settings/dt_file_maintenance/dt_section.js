...
export var dtSection = function (param) {
    ...
    function initTable(){
        ...
        dataTableHelper.initTable(
            'hris/admin/settings/file_maintenance/section/dt',
            {
                filter_status:false,
            },
            [
                ...
                {
                    data: "code", name: "code", title: "Section Code",
                    sortable:false,
                    searchable:false,
                    visible:false,
                },
                {
                    data: "name", name: "name", title: "Section",
                    sortable:false,
        ...
        $(`#${_table}_table`).ready(function() {
            ...
            $(`#${_table}_table`).on('click','.view-details',function(e){
                ...
                let modal_id = '#modal_add_section';
                let form = $('#form_add_section');

                let formData = new FormData;

                formData.append('id',id);
                _request.post('/hris/admin/settings/file_maintenance/section/info',formData)
                .then((res) => {
            ...
            $(`#${_table}_table`).on('click','.delete',function(e){
                ...
                Alert.confirm('question','Delete this record ?',{
                    onConfirm: function() {
                        formData.append('id',id);
                        _request.post('/hris/admin/settings/file_maintenance/section/delete',formData)
                        .then((res) => {
