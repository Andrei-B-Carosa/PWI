...
export var dtCompany = function (param) {

    const _page = $('.page-file-maintenance-settings');
    const _table = 'company';
    const _tab = $(`.${_table}`);
    ...
    function initTable(){
        ...
        dataTableHelper.initTable(
            'hris/admin/settings/file_maintenance/company/dt',
            {
                filter_status:false,
            },
            [
                ...
                {
                    data: "name", name: "name", title: "Company",
                    sortable:false,
                },
                {
        ...
        $(`#${_table}_table`).ready(function() {
            ...
            $(`#${_table}_table`).on('click','.view-details',function(e){
                ...
                let modal_id = '#modal_add_company';
                let form = $('#form_add_company');

                let formData = new FormData;

                formData.append('id',id);
                _request.post('/hris/admin/settings/file_maintenance/company/info',formData)
                .then((res) => {
            ...
            $(`#${_table}_table`).on('click','.delete',function(e){
                ...
                Alert.confirm('question','Delete this record ?',{
                    onConfirm: function() {
                        formData.append('id',id);
                        _request.post('/hris/admin/settings/file_maintenance/company/delete',formData)
                        .then((res) => {
