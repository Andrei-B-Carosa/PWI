...
export var dtClassification = function (param) {

    const _page = $('.page-file-maintenance-settings');
    const _table = 'classification';
    const _tab = $(`.${_table}`);
    ...
    function initTable(){
        ...
        dataTableHelper.initTable(
            'hris/admin/settings/file_maintenance/classification/dt',
            {
                filter_status:false,
            },
            [
                ...
                {
                    data: "name", name: "name", title: "Classification",
                    sortable:false,
                },
                {
        ...
        $(`#${_table}_table`).ready(function() {
            ...
            $(`#${_table}_table`).on('click','.view-details',function(e){
                ...
                _request.post('/hris/admin/settings/file_maintenance/classification/info',formData)
                .then((res) => {
            ...
            $(`#${_table}_table`).on('click','.delete',function(e){
                ...
                Alert.confirm('question','Delete this record ?',{
                    onConfirm: function() {
                        formData.append('id',id);
                        _request.post('/hris/admin/settings/file_maintenance/classification/delete',formData)
                        .then((res) => {
