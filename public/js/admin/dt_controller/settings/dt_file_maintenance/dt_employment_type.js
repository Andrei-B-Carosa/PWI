...
export var dtEmploymentType = function (param) {

    const _page = $('.page-file-maintenance-settings');
    const _table = 'employment_type';
    const _tab = $(`.${_table}`);
    ...
    function initTable(){
        ...
        dataTableHelper.initTable(
            'hris/admin/settings/file_maintenance/employment_type/dt',
            {
                filter_status:false,
            },
            [
                ...
                {
                    data: "name", name: "name", title: "Employment Type",
                    sortable:false,
                },
                {
        ...
        $(`#${_table}_table`).ready(function() {
            ...
            $(`#${_table}_table`).on('click','.view-details',function(e){
                ...
                let modal_id = '#modal_add_employment_type';
                let form = $('#form_add_employment_type');

                let formData = new FormData;

                formData.append('id',id);
                _request.post('/hris/admin/settings/file_maintenance/employment_type/info',formData)
                .then((res) => {
            ...
            $(`#${_table}_table`).on('click','.delete',function(e){
                ...
                Alert.confirm('question','Delete this record ?',{
                    onConfirm: function() {
                        formData.append('id',id);
                        _request.post('/hris/admin/settings/file_maintenance/employment_type/delete',formData)
                        .then((res) => {
