<div class="page-ob-request">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="card card-dashed flex-center min-w-175px my-3 p-6">
                <span class="fs-4 fw-semibold text-success pb-1 px-2">Approved OT</span>
                <span class="fs-lg-2tx fw-bold d-flex justify-content-center">
        ...
        <div class="col">
            <div class="card card-dashed flex-center min-w-175px my-3 p-6">
                <span class="fs-4 fw-semibold text-danger pb-1 px-2">Rejected OT</span>
                <span class="fs-lg-2tx fw-bold d-flex justify-content-center">
        ...
        <div class="card-header border-0 pb-6 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_request_ob">
                        Request a OB
                    </button>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header justify-content-center" id="kt_modal_add_user_header">
                    <div class="text-center">
                        <h1 class="mb-3 modal_title">Official Business Form</h1>
                ...
                <div class="modal-body px-5">
                    <form id="form_request_ob" modal-id="#modal_request_ob" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="/hris/employee/request/official_business/update">
                        <div class="px-5 px-lg-10">
                            <div class="d-flex flex-column fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" name="ob_filing_date" input-control="date-picker" default-date="current" class="form-control mb-3 mb-lg-0 flatpickr" disabled>
                           ...
                           <div class="row">
                                <div class="d-flex flex-column col-6 fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="ob_time_out" input-control="time-picker" default-format="24" default-date="current" class="form-control form-control-solid mb-3 mb-lg-0">
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                </div>
                                <div class="d-flex flex-column col-6 fv-row mb-7 fv-plugins-icon-container">
                                    <label class="required fw-semibold fs-6 mb-2">Time In</label>
                                    <input type="text" name="ob_time_in" input-control="time-picker" default-format="24"  default-date="current" class="form-control form-control-solid mb-3 mb-lg-0">
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                </div>
                           </div>
                           <div class="fv-row mb-7 col-12 fv-plugins-icon-container">
                            <label class="required fw-semibold fs-6 mb-2">Contact Person</label>
                            <select name="contact_person" data-control="select2" data-placeholder="Select an option" class="form-select modal-select form-select-solid fw-bold">
                                <option></option>
                            </select>
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                        </div>
                           <div class="d-flex flex-column fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" name="destination" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Destination">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                            </div>
                            <div class="d-flex fv-row flex-column mb-7">
                                <label class="fs-6 required fw-semibold mb-2">Purpose</label>
                                <textarea class="form-control form-control-solid" rows="5" name="purpose" placeholder="Purpose"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
