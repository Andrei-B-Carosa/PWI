...
<div class="row g-5 g-lg-10">
    ...
    <div class="col-xl-4 mb-xl-10">
        ...
        <div class="card h-md-100">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                        data-kt-menu="true" id="kt_menu_65289c7792e54">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" multiple
                                        ...
                                        data-dropdown-parent="#kt_menu_65289c7792e54"
            ...
            <div class="card-body p-0 d-flex flex-column">
                ...
                <!--begin::Chart-->
                <div id="kt_charts_mixed_widget_19_chart" class="card-rounded-bottom"
    ...
    <div class="col-xl-4">
                ...
                <a href="#" class="card bg-body h-150px">
                    ...
                    <div class="card-body d-flex flex-column py-6 px-6">
                        <div class="d-flex flex-column flex-grow-1 mb-5">
                            <span class="text-gray-500 fw-semibold me-2 fs-7">Author
                                Stats</span>
        ...
        <div class="row g-5 g-lg-10">
            ...
            <div class="col-lg-6 mb-5 mb-lg-10">
                ...
                <a href="#" class="card bg-primary h-150px">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        <i
                            class="ki-duotone ki-chart-pie-simple text-white fs-2hx ms-n1 flex-grow-1"><span
        ...
        <a href="#" class="card bgi-no-repeat h-150px mb-xl-10"
            style="background-color: #4AB58E; background-position: calc(100% + 1rem) bottom; background-size: 25% auto; background-image:url('assets/media/svg/humans/custom-1.svg')">
    ...
    <div class="col-xl-4 mb-xl-10">
        ...
        <div class="card bgi-no-repeat h-xl-100 mb-5 mb-lg-10"
            style="background-color: #1B283F; background-position: 0 calc(100% + 0.5rem); background-size: 100% auto; background-image:url('assets/media/svg/general/rhone.svg')">
...
<div class="row g-5 g-lg-10">
    ...
    <div class="col-xl-4 mb-xl-10">
        ...
        <div
            class="card bgi-no-repeat bgi-position-y-top bgi-position-x-end statistics-widget-1 h-xl-100">
            <!--begin::Body-->
            <div class="card-body">
                <a href="#"
    ...
    <div class="col-xl-4 mb-xl-10">
        ...
        <!--begin::Statistics Widget 1-->
        <div
            class="card bgi-no-repeat bgi-position-y-top bgi-position-x-end statistics-widget-2 h-xl-100">
            <!--begin::Body-->
            <div class="card-body">
                <a href="#"
                    class="card-title fw-bold text-muted text-hover-primary fs-4">Meeting
    ...
    <div class="col-xl-4 mb-5 mb-lg-10">
        ...
        <!--begin::Statistics Widget 1-->
        <div
            class="card bgi-no-repeat bgi-position-y-top bgi-position-x-end statistics-widget-3 h-xl-100">
            <!--begin::Body-->
            <div class="card-body">
        ...
        <div class="card h-md-100">
            ...
            <div class="card-header align-items-center border-0 mt-4">
                ...
                <div class="card-toolbar">
                    ...
                    <!--begin::Menu 1-->
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                        data-kt-menu="true" id="kt_menu_65289c7792ef4">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                            <div class="fs-5 text-dark fw-bold">Filter Options</div>
                        </div>
                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" multiple
                                        data-kt-select2="true" data-close-on-select="false"
                                        data-placeholder="Select option"
                                        data-dropdown-parent="#kt_menu_65289c7792ef4"
                                        data-allow-clear="true">
                                        <option></option>
                                        <option value="1">Approved</option>
                                        <option value="2">Pending</option>
        ...
        <div class="card h-md-100">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <!--begin::Menu 1-->
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                        data-kt-menu="true" id="kt_menu_65289c7792f0f">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                            <div class="fs-5 text-dark fw-bold">Filter Options</div>
                        </div>
                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" multiple
                                        data-kt-select2="true" data-close-on-select="false"
                                        data-placeholder="Select option"
                                        data-dropdown-parent="#kt_menu_65289c7792f0f"
                                        data-allow-clear="true">
                                        <option></option>
                                        <option value="1">Approved</option>
                                        <option value="2">Pending</option>
            ...
            <div class="card-body p-0 d-flex flex-column">
                ...
                <!--begin::Chart-->
                <div class="mixed-widget-6-chart card-rounded-bottom"
            ...
            <div class="card-body p-0">
                ...
                <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1"
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="symbol symbol-45px w-40px me-5">
                            <span class="symbol-label bg-lighten">
                                <i class="ki-duotone ki-compass fs-1"><span
                                        class="path1"></span><span class="path2"></span></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="symbol symbol-45px w-40px me-5">
                            <span class="symbol-label bg-lighten">
                                <i class="ki-duotone ki-element-11 fs-1"><span
                                        class="path1"></span><span class="path2"></span><span
                                        class="path3"></span><span class="path4"></span></i>
                            </span>
                        </div>
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="symbol symbol-45px w-40px me-5">
                            <span class="symbol-label bg-lighten">
                                <i class="ki-duotone ki-graph-up fs-1"><span
                                        class="path1"></span><span class="path2"></span><span
                                ...
                                <td>
                                    <div class="symbol symbol-50px me-2">
                                        <span class="symbol-label bg-light-danger">
                                            <i
                                                class="ki-duotone ki-element-11 fs-2x text-danger"><span
                                                    class="path1"></span><span
                                                    class="path2"></span><span
                                                    class="path3"></span><span
                                                    class="path4"></span></i> </span>
                                ...
                                <td>
                                    <div class="symbol symbol-50px me-2">
                                        <span class="symbol-label bg-light-warning">
                                            <i
                                                class="ki-duotone ki-abstract-26 fs-2x text-warning"><span
                                                    class="path1"></span><span
                                                    class="path2"></span></i> </span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="symbol symbol-50px me-2">
                                        <span class="symbol-label bg-light-primary">
                                            <i
                                                class="ki-duotone ki-abstract-41 fs-2x text-primary"><span
                                                    class="path1"></span><span
                                                    class="path2"></span></i> </span>
                                    </div>
                                </td>
